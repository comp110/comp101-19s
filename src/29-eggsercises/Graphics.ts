...
import { currentPlayer, winner, pick } from "./EggRoulette";
...
export class Graphics {
    ...
    winner = (): Text => {
        let winText: Text = new Text("Player " + winner(this.game) + " wins!");
